...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE plate SET  thecarownersname=%s, paintingsource=%s,  paintingclass=%s, boogiesource=%s, paintingcolor=%s, noboogie=%s, thechassisnumber=%s WHERE platenumber=%s",
...
mysql_select_db($database_myonn, $myonn);
$query_Recordset1 = "SELECT * FROM plate WHERE platenumber='".$_POST['hidup']."' ";
