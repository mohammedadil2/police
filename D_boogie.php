...
if ((isset($_POST['hid_del'])) && ($_POST['hid_del'] != "")) {
  $deleteSQL = sprintf("DELETE FROM boogie WHERE platenumber=%s",
...
mysql_select_db($database_myonn, $myonn);
$query_Recordset1 = "SELECT * FROM boogie";
...
<div id="slider3" class="nivoSlider" style="width: 630px; height: 280px"> <a href="#"><img title="شرطة المرور" src="1.jpg" alt="" width="630" height="280"></a> <img  src="2.jpg" alt="" width="630" height="280"> <img  src="3.jpg" alt="" width="630" height="280"> <img  src="4.jpg" alt="" width="630" height="280"> </div>
    ...
    <div class="one-third">
	<h3>تعديل او حذف الاستعلام</h3>
    <table width="708%" border="1" cellpadding="3" cellspacing="3">
      <tr> 
	    <td>رقم اللوحة</td>
        <td>اسم صاحب المركبه</td>
        <td>مصدر اللوحة</td>
        <td>فئة اللوحة</td>
        <td>مصدر الرخصة</td>
        <td>لون اللوحة</td>
        <td>رقم الرخصة</td>
        <td>رقم هيكل السيارة</td>
    <td>مسح</td>
	<td>تعديل</td>
      </tr>
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_Recordset1['thecarownersname']; ?></td>
      <td><?php echo $row_Recordset1['paintingsource']; ?></td>
            <td><?php echo $row_Recordset1['paintingclass']; ?></td>
      <td><?php echo $row_Recordset1['boogiesource']; ?></td>
            <td><?php echo $row_Recordset1['paintingcolor']; ?></td>
      <td><?php echo $row_Recordset1['noboogie']; ?></td>
      <td><?php echo $row_Recordset1['thechassisnumber']; ?></td>      
      <td><form id="form2" name="form2" method="post" action="">
        <input type="submit" name="del" id="del" value="مسح" />
        <input name="hid_del" type="hidden" id="hid_del" value="<?php echo $row_Recordset1['platenumber']; ?>" />
      </form></td>
      <td><form id="form1" name="form1" method="post" action="up_boogie">
        <input type="submit" name="btn" id="btn" value="تعديل" />
        <input name="hidup" type="hidden" id="hidup" value="<?php echo $row_Recordset1['platenumber']; ?>" />
      </form></td>
    </tr>
