...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO  employee (ID, name, addrees,  phone, user, pass) VALUES (%s, %s, %s, %s, %s, %s)",
...
<div id="container">
  <div class="two-third">
<div id="slider3" class="nivoSlider" style="width: 630px; height: 280px"> <a href="#"><img title="شرطة المرور" src="1.jpg" alt="" width="630" height="280"></a> <img  src="2.jpg" alt="" width="630" height="280"> <img  src="3.jpg" alt="" width="630" height="280"> <img  src="4.jpg" alt="" width="630" height="280"> </div>	 <div style="clear:both"></div>
    <div class="one-third">
	<h3>اضافة موظف جديد</h3>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td nowrap align="right">رقم الموظف:</td>
          <td><input type="text" name="ID" value="<? echo $num ; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">اسم الموظف:</td>
          <td><input type="text" name="name" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">العنوان:</td>
          <td><input type="text" name="addrees" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">رقم الهاتف:</td>
          <td><input type="text" name="phone" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">اسم الدخول:</td>
