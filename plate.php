...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO  plate (platenumber, thecarownersname, paintingsource,  paintingclass, boogiesource, paintingcolor, noboogie, thechassisnumber) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
