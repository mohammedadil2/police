...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO  boogie (platenumber, thecarownersname, paintingsource,  paintingclass, boogiesource, paintingcolor, noboogie, thechassisnumber) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="header">
  <!-- Logo/Title -->
  <div id="site_title"><a href="#"><img src="x.jpg" height="69"></a> </div>
  <!-- Main Menu -->
  <ol id="menu">
...
<div id="slider3" class="nivoSlider" style="width: 630px; height: 280px"> <a href="#"><img title="شرطة المرور" src="1.jpg" alt="" width="630" height="280"></a> <img  src="2.jpg" alt="" width="630" height="280"> <img  src="3.jpg" alt="" width="630" height="280"> <img  src="4.jpg" alt="" width="630" height="280"> </div>
    ...
    <div class="one-third">
	<h3>اضافة استعلام جديد</h3>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td nowrap align="right">رقم اللوحة:</td>
          <td><input type="text" name="platenumber" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">اسم صاحب المركبه:</td>
          <td><input type="text" name="thecarownersname" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">مصدر اللوحة:</td>
          <td><input type="text" name="paintingsource" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">فئة اللوحة:</td>
		     <td><select  name="paintingclass">
		  <option>عام</option>
		  <option>خاص</option></td>
		  </select>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">مصدر الرخصة:</td>
          <td><input type="text" name="boogiesource" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">لون اللوحة:</td>
          <td><select  name="paintingcolor">
		  <option>ابيض</option>
		  <option>اسود</option>
		  <option>اخضر</option></td>
		  </select>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">رقم الرخصة:</td>
          <td><input type="text" name="noboogie" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">رقم هيكل السيارة:</td>
          <td><input type="text" name="thechassisnumber" value="" size="32"></td>
        </tr>
                <tr valign="baseline">
